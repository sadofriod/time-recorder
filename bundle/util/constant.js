...
var JS_ERROR_LOG_PATH = function (date) { return "/app/tempAsset/" + date + "/js_error.log"; };
exports.JS_ERROR_LOG_PATH = JS_ERROR_LOG_PATH;
var JS_LOG_PATH = function (date) { return "/app/tempAsset/" + date + "/js_access.log"; };
exports.JS_LOG_PATH = JS_LOG_PATH;
var NETWORK_ERROR_LOG_PATH = function (date) { return "/app/tempAsset/" + date + "/network_error.log"; };
exports.NETWORK_ERROR_LOG_PATH = NETWORK_ERROR_LOG_PATH;
var NETWORK_LOG_PATH = function (date) { return "/app/tempAsset/" + date + "/network_access.log"; };
exports.NETWORK_LOG_PATH = NETWORK_LOG_PATH;
var RESPONSE_LOG_PATH = function (date) { return "/app/tempAsset/" + date + "/network_response.log"; };
